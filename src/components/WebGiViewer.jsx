...
const WebGiViewer = forwardRef((props, ref) => {
    ...
    const scrollAnimationFn = useCallback((position, target, isMobile, onUpdate) => {
    ...
    const setupViewer = useCallback( async () => {
        ...
        scrollAnimationFn(position, target, isMobileOrTablet, onUpdate)
    }, [])
    ...
    return (
        <div ref={canvasContainerRef} id='webgi-canvas-container'>
            ...
            {
                previewMode && (
                    <button onClick={() => handlePreviewExit()} className='button'>Exit</button>
                )
            }
        </div>
    )
